  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="absolute left-8 top-4 size-1 animate-pulse rounded-full bg-white/30" style={{ animationDuration: '3s' }} />
        <div className="absolute right-12 top-8 size-1.5 animate-pulse rounded-full bg-white/20" style={{ animationDelay: '1s', animationDuration: '4s' }} />
        <div className="absolute bottom-6 left-1/3 size-1 animate-pulse rounded-full bg-white/25" style={{ animationDelay: '2s', animationDuration: '5s' }} />
        <div className="absolute bottom-3 right-1/4 size-1 animate-pulse rounded-full bg-white/15" style={{ animationDelay: '1.5s', animationDuration: '3.5s' }} />
      </div>
