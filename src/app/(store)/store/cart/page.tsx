                      ...
                      <div className="flex gap-4">
                        ...
                        <div className="flex-shrink-0">
                          <Link href={`/store/product/${line.merchandise.product.handle}`}>
                            <div className="aspect-square h-24 w-24 overflow-hidden rounded-lg border">
            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  {cartSummary?.cart?.discountCodes && cartSummary.cart.discountCodes.length > 0 && (
                    <div className="space-y-1">
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  {cartSummary?.cart?.discountAllocations && cartSummary.cart.discountAllocations.length > 0 && (
                    <>
                      <Separator />
                      {cartSummary.cart.discountAllocations.map((discount, index) => (
                        <div key={index} className="flex justify-between text-green-600">
                          <span>
                            Descuento {discount.code ? `(${discount.code})` : ''}:
                          </span>
                          <span>
                            -{formatCurrency(
