...
import { getPrivateProductIds, getPrivateRoomByUserId, shopifyService } from '@/modules/shopify/service';
    ...
    if (privateProductIds.includes(product.id)) {
      ...
      if (isAdminOrManager) {
        ...
        try {
          ...
          if (!userPrivateRoom || !userPrivateRoom.products.some((p: PrivateRoomProduct) => p.productId === product.id)) {
            notFound();
          }
