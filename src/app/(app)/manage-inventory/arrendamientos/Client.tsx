      ...
      <div className='space-y-4 p-4 md:p-6'>
        <div className='flex min-h-96 items-center justify-center'>
          <div className='text-center'>
            <h3 className='text-lg font-semibold text-red-600'>Error al cargar arrendamientos</h3>
    ...
    <div className='min-w-0 max-w-full space-y-4 p-2 md:p-4'>
      <div className='flex min-w-0 flex-col space-y-3 sm:flex-row sm:items-center sm:justify-between sm:space-y-0'>
        <div>
          ...
          <h1 className='text-2xl font-bold'>Gestión de Arrendamientos</h1>
          <p className='text-muted-foreground'>
            Administra los tipos de arrendamientos para tus productos
          </p>
        </div>
        <div className='flex items-center space-x-2'>
          ...
          <Link href={ROUTES.INVENTORY.ARRENDAMIENTOS.CREATE.PATH}>
            <Button>
      ...
      <div className='grid grid-cols-2 gap-2 sm:grid-cols-2'>
        ...
        <div className='rounded-lg border p-2'>
          <div className='flex items-center justify-between'>
            ...
            <Badge variant='default'>{activeArrendamientos.length}</Badge>
          </div>
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <div className='w-full min-w-0 max-w-full overflow-x-auto pb-2'>
          <Table.Data
            ...
            emptyMessage='No se encontraron arrendamientos.'
          />
        </div>
      )}
